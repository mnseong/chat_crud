              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage('images/Arin.png'), fit: BoxFit.cover),
                ),
                child: Container(
                    ...
                    children: [
                      RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text: isSignupScreen ? ' Create your Account!' : ' Enjoy Our Service *_*',
                              style: const TextStyle(
                                letterSpacing: 1.0,
                                fontSize: 25,
                                color: Colors.white,
                      ...
                      Text(
                        isSignupScreen ? 'Please Sign Up your Account' : 'Sign In your Account',
                        style: const TextStyle(
                          letterSpacing: 1.0,
                          color: Colors.white,
                        ),
